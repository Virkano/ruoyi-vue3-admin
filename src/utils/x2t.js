...
export const convertDocument = file => x2tConverter.convertDocument(file)
export function convertBinToDocumentAndDownload(bin, fileName, targetExt) {
